...
class Zstd__Stream__Lambda__KnownFinalSize
{

public:


    Zstd__Stream__Lambda__KnownFinalSize()
    {
...
public:
    ...
    const result_flag run_StartStream(const int num_thread, const int level_compressed, const size_t FinalySize, const size_t CHUNK_SIZE, const char* PointerToData_WhichShouldBe_Compressed, const size_t DataSize_WhichShouldBe_Compressed, const Stream_flag User_Stream_flag)
    {
        ...
        const size_t ZSTD_CCtx_setPledgedSrcSize_ = ZSTD_CCtx_setPledgedSrcSize(Compress_struct_.ZSTD_CStream_, FinalySize);
    ...
    void set__LambdaCallback(std::function<void(const callback_flag status, const char* Pointer_to_ChunkBeforeCompressData, const size_t ChunkBeforeCompressData_size, const char* Pointer_to_ChunkCompressData, const size_t ChunkCompressData_size, const size_t garant_MaxSize_for_CompressedResult, Zstd__Stream__Lambda__KnownFinalSize* Zstd__Stream__Lambda_p)> lambda_callback_)
    {
    ...
    const result_flag run_Uncompress(const size_t CHUNK_SIZE, const char* PointerToData_WhichShouldBe_Uncompressed, const size_t DataSize_WhichShouldBe_Uncompressed, std::function<void(const callback_flag status, const char* Pointer_to_ChunkBeforeCompressData, const size_t ChunkBeforeCompressData_size, const char* Pointer_to_ChunkCompressData, const size_t ChunkCompressData_size, Zstd__Stream__Lambda__KnownFinalSize* Zstd__Stream__Lambda__KnownFinalSize_p)> lambda_callback)
    {
...
private:
    ...
    struct Compress_struct
    {
        ...
        //-----------------------------------
        std::function<void(const callback_flag status, const char* Pointer_to_ChunkBeforeCompressData, const size_t ChunkBeforeCompressData_size, const char* Pointer_to_ChunkCompressData, const size_t ChunkCompressData_size, const size_t garant_MaxSize_for_CompressedResult, Zstd__Stream__Lambda__KnownFinalSize* Zstd__Stream__Lambda_p)> lambda_callback;
        //-----------------------------------
